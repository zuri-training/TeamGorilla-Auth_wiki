        ...
        <div className="about_section">
          ...
          <div className="about_text">
            ...
            <p style={{ padding: "1rem 0 3rem 0" }}>
              We are a group of tech savvy individuals with an aim to elevate
              the technology industry through speed and agility. One of the
              solutions we are proud to offer is our authentication library. Our
              team is made up of tech enthusiast with a forward driven mind set.
            </p>
      ...
      <div className="testimonial_section">
        ...
        <div className="testimonials__">
          <div className="testimonial">
            ...
            <p>
              The days of coding from scratch are over. Authwiki greatly reduces
              turn around time. I will definitely reccommend this to any serious
              developer out there
            </p>
          </div>
          <div className="testimonial">
      ...
      <div className="newsletter_section">
        <div className="newsletter_text">
          <h3 style={{ fontSize: "24px" }}>
            Do you want to get updates from AuthWiki?
          </h3>
